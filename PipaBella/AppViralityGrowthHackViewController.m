...
//    self = [self initWithStyle:UITableViewStylePlain];
    if (self) {
      ...
      //  headerView.backgroundColor = [UIColor redColor];
        self.greetingLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT/20, SCREEN_WIDTH, 50)];
        ...
        self.greetingLabel.font = [UIFont boldSystemFontOfSize:24];
...
//        }
        ...
        self.moreButton.frame = CGRectMake((SCREEN_WIDTH/2)-22,CGRectGetMaxY(self.facebookButton.frame)+350, 45, 27);
