...
- (void)setType:(MozAlertType)type text:(NSString*)text doText:(NSString*)doText{
    ...
    leftIcon = [[UIImageView alloc]initWithFrame:CGRectMake(12, 10, 20, 20)];
    ...
    switch (type) {
        case MozAlertTypeInfo:{
            self.backgroundColor = [UIColor colorWithRed:38/255.0 green:152/255.0 blue:194/255.0 alpha:1.0];
            leftIcon.hidden = YES;
        ...
        case MozAlertTypeSuccess:
            ...
            leftIcon.image=[UIImage imageNamed:@"sign.png"];
        ...
        case MozAlertTypeWarning:
            ...
            //leftIcon.text = [NSString fontAwesomeIconStringForEnum:FAExclamationCircle];
             leftIcon.image=[UIImage imageNamed:@"excl.png"];
